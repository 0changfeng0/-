...
def ser_send(msg, ser):
    ...
    print(1)
    time.sleep(0.01)  # 延时，否则len_return_data将返回0
    ...
    while True:
        try:
            ...
            if depth_image_handle and color_image_handle:
                ...
                # cv2.circle(color_image,(100,200),50,(0,255,0),2,0)
                # cv2.putText(color_image,'image',(50,50),cv2.FONT_HERSHEY_SIMPLEX,1,(0,255,0),1,4)
                # cv2.rectangle(color_image,(20,30),(50,45),(0,255,0),1)
                # cv2.line(color_image,(100,200),(100,250),(0,255,0),1)
                # cv2.namedWindow('color_image', cv2.WINDOW_NORMAL)
                # cv2.setWindowProperty('color_image', cv2.WND_PROP_FULLSCREEN, cv2.WINDOW_FULLSCREEN)
