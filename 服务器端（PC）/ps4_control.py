...
class MyMainForm(QMainWindow, Ui_Form):
    def __init__(self, robot,azure_server,parent=None):
    ...
    def display(self):
        ...
        # k=self.azure_server.receive_image(msg)
...
if __name__ == '__main__':
    ...
    azure_server = Azure_udp_server(HOST='', PORT=25490, buffSize=65535)
    app = QApplication(sys.argv)
    myWin = MyMainForm(robot,azure_server)
    #将窗口控件显示在屏幕上
    myWin.show()
